...
subroutine allOmkeerVariantTests
    ...
    call testWithLevel(omkeerVariantTestBasic,                                "omkeerVariantTest: inverse of overtoppingDllTest test", level)
    call testWithLevel(omkeerVariantTestWithHighDischarge,                    "omkeerVariantTest: high discharge", level)
    call testWithLevel(omkeerVariantTestWithDikeHeigthInProfile,              "omkeerVariantTest: expected dikeheight in profile", level)
    call testWithLevel(omkeerVariantTestWithBerm,                             "omkeerVariantTest: with berm", level)
    call testWithLevel(omkeerVariantTestWithBermAndDikeHeightJustAboveBerm1,  "omkeerVariantTest: with berm and dikeheight just above berm", level)
    call testWithLevel(omkeerVariantTestWithBermAndDikeHeightJustAboveBerm2,  "omkeerVariantTest: with berm and expected dikeheight just above berm", level)
    call testWithLevel(omkeerVariantTestWith1_15BermAndDikeHeightHalfwayBerm, "omkeerVariantTest: with 1:15 berm and expected dikeheight halfway berm", level)
    call testWithLevel(omkeerVariantTestWithVerySmallDischarge,               "omkeerVariantTest: with a very small discharge", level)
    call testWithLevel(omkeerVariantTestWithWaterlevelBelowToe,               "omkeerVariantTest: with water level below toe", level)
    call testWithLevel(omkeerVariantTestWithExpectedDikeheightHalfwaySlope,   "omkeerVariantTest: with expected dikeheight halfway last slope segment", level)
    call testWithLevel(omkeerVariantIssue34A,                                 "omkeerVariantTest: 1st test related to issue 34", level)
    call testWithLevel(omkeerVariantIssue34B,                                 "omkeerVariantTest: 2nd test related to issue 34", level)
    call testWithLevel(omkeerVariantIssue34C,                                 "omkeerVariantTest: 3rd test related to issue 34", level)
    call testWithLevel(omkeerVariantIssue35A,                                 "omkeerVariantTest: 1st test related to issue 35", level)
    call testWithLevel(omkeerVariantIssue35B,                                 "omkeerVariantTest: 2nd test related to issue 35", level)
    call testWithLevel(omkeerVariantIssue35C,                                 "omkeerVariantTest: 3rd test related to issue 35", level)
    call testWithLevel(omkeerVariantIssue36A,                                 "omkeerVariantTest: 1st test related to issue 36: wl at toe; 1:4; long dike", level)
    call testWithLevel(omkeerVariantIssue36B,                                 "omkeerVariantTest: 2nd test related to issue 36: wl at toe; 1:4; short dike", level)
    call testWithLevel(omkeerVariantIssue42A,                                 "omkeerVariantTest: 1st test related to issue 42: berm at waterlevel", level)
    call testWithLevel(omkeerVariantIssue42B,                                 "omkeerVariantTest: 2nd test related to issue 42: resulting dikeheight at end of berm", level)
