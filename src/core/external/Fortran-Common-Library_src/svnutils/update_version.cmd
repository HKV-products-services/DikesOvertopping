...
set SVNVERSION="%SCRIPT_DIRECTORY%\win32\svnversion.exe"
REM Temporariry fix until TeamCity is compatible with svn 1.8
set SVNVERSION17="%SCRIPT_DIRECTORY%\win32-17\svnversion.exe"
set VN="%SCRIPT_DIRECTORY%\win32\version_number.exe"
...
rem Strip off the "M" if present, as C# does not allow it
