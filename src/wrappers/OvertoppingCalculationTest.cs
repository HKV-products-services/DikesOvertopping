...
namespace TestWrapper
{
    ...
    public class OvertoppingCalculationTest
    {
        ...
        public static void TestOvertoppingValidation()
        {
            ...
            Assert.AreEqual(msg[0], "FOUT:Y-coordinaten mogen niet afnemen.   5.00 en    4.00 doen dat wel.", "validation message");
            Assert.AreEqual(msg[1], "FOUT:Y-coordinaten mogen niet afnemen.   4.00 en    0.00 doen dat wel.", "validation message");
        }
