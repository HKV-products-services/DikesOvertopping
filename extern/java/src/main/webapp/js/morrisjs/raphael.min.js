    ...
    return function (t) {
        ...
        i = [r(2)], n = function (t) {
            ...
            function p(t, r, i) {
                ...
                for (x = 0; h > x; x++) for (var y = 0; c > y; y++) {
                    var m = f[x], b = f[x + 1], _ = p[y], w = p[y + 1], k = H(b.x - m.x) < .001 ? "y" : "x",
            ...
            var w, k = /[, ]+/, B = {circle: 1, rect: 1, path: 1, ellipse: 1, text: 1, image: 1}, C = /\{(\d+)\}/g,
                S = "prototype", T = "hasOwnProperty", A = {doc: document, win: window},
                E = {was: Object.prototype[T].call(A.win, "Raphael"), is: A.win.Raphael}, N = function () {
                    this.ca = this.customAttributes = {}
                }, M, L = "appendChild", z = "apply", P = "concat",
                F = "ontouchstart" in A.win || A.win.DocumentTouch && A.doc instanceof DocumentTouch, R = "", I = " ",
                j = String, q = "split",
                D = "click dblclick mousedown mousemove mouseout mouseover mouseup touchstart touchmove touchend touchcancel"[q](I),
                V = {mousedown: "touchstart", mousemove: "touchmove", mouseup: "touchend"}, O = j.prototype.toLowerCase,
                ...
                ht = parseFloat, ut = parseInt, ct = j.prototype.toUpperCase, ft = e._availableAttrs = {
                    "arrow-end": "none",
                    "arrow-start": "none",
                    blur: 0,
                ...
                xt = {hs: 1, rg: 1}, vt = /,?([achlmqrstvxz]),?/gi,
            ...
            var Ot = e.pathBBox = function (t) {
                ...
                var c = G[z](0, a), f = G[z](0, s), p = W[z](0, a), d = W[z](0, s), g = p - c, x = d - f,
                ...
                A = T - S;
                var L = Y.cos(S), z = Y.sin(S), F = Y.cos(T), R = Y.sin(T), I = Y.tan(A / 4), j = 4 / 3 * r * I,
                    D = 4 / 3 * i * I, V = [t, e], O = [t + j * z, e - D * L], W = [l + j * R, h - D * F], G = [l, h];
                ...
                if (h.transform = i || [], i) for (var c = 0, f = i.length; f > c; c++) {
                    var p = i[c], d = p.length, x = j(p[0]).toLowerCase(), v = p[0] != x, y = v ? u.invert() : 0, m, b,
                        _, w, k;
            ...
            for (var he = function () {
                ...
                return A.doc.addEventListener ? function (t, e, r, i) {
                    ...
                    var n = function (t) {
                        t = t || A.win.event;
                        var e = A.doc.documentElement.scrollTop || A.doc.body.scrollTop,
                            n = A.doc.documentElement.scrollLeft || A.doc.body.scrollLeft, a = t.clientX + n,
                            s = t.clientY + e;
            ...
            ye.drag = function (r, i, n, a, s, o) {
                function l(l) {
                    ...
                    var h = l.clientX, u = l.clientY, c = A.doc.documentElement.scrollTop || A.doc.body.scrollTop,
            ...
            var Ae = e.easing_formulas = {
                linear: function (t) {
                    ...
                    var e = .48 - t / 1.04, r = Y.sqrt(.1734 + e * e), i = r - e, n = X(H(i), 1 / 3) * (0 > i ? -1 : 1),
                        a = -r - e, s = X(H(a), 1 / 3) * (0 > a ? -1 : 1), o = n + s + .5;
        ...
        !function (r) {
            var a = "0.4.2", s = "hasOwnProperty", o = /[\.\/]/, l = "*", h = function () {
                ...
                t = String(t);
                var r = p, i = f, n = Array.prototype.slice.call(arguments, 2), a = d.listeners(t), s = 0, o = !1, l,
                    h = [], g = {}, x = [], v = c, y = [];
                c = t, f = 0;
        ...
        i = [r(1)], n = function (t) {
            if (!t || t.vml) {
                var e = "hasOwnProperty", r = String, i = parseFloat, n = Math, a = n.round, s = n.max, o = n.min,
                    ...
                    x = /([clmz]),?([^clmz]*)/gi, v = / progid:\S+Blur\([^\)]+\)/g, y = /-?[^,\s-]+/g,
                    ...
                    _ = {path: 1, rect: 1, image: 1}, w = {circle: 1, ellipse: 1}, k = function (e) {
                        ...
                        var s = t._, o = t.matrix, u = s.fillpos, c = t.node, f = c.style, d = 1, g = "", x, v = b / e,
                            y = b / r;
                ...
                var S = function (t, e, i) {
                    ...
                    n.attrs = n.attrs || {};
                    var c = n.node, f = n.attrs, g = c.style, x,
